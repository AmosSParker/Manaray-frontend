...
function instrumentXHR() {
  ...
  utils.fill(xhrproto, 'open', function (originalOpen) {
    return function ( ...args) {
      ...
      const method = utils.isString(args[0]) ? args[0].toUpperCase() : undefined;
      ...
      if ('onreadystatechange' in this && typeof this.onreadystatechange === 'function') {
        utils.fill(this, 'onreadystatechange', function (original) {
      ...
      utils.fill(this, 'setRequestHeader', function (original) {
  ...
  utils.fill(xhrproto, 'send', function (originalSend) {
    return function ( ...args) {
